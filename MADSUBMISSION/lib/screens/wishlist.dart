  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          itemBuilder: (context, index) {
            return Card(
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(color: Colors.grey[300]!, width: 1.0), // Adjust border color and width
              ),
              child: Stack(
                children: [
                  Column(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 2.0), // Add space between description and buttons
                            Row(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 2, // Set the initial selected index to the Wishlist tab
        selectedItemColor: Colors.yellow,
        unselectedItemColor: Colors.white60,
        backgroundColor: orientation == Orientation.portrait ? Colors.brown[800] : Colors.pink[200],
